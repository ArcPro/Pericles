...
#include <PericlesClient/Fonts/CFont.hpp>
...
class CRenderObjectDrawLineBatch final : public IRenderObject
{
public:
	explicit CRenderObjectDrawLineBatch( std::vector<RenderLine_t>&& Lines ) :
...
private:
	std::vector<RenderLine_t> m_Lines;
};
...
public:
	...
	auto DrawLineBatch( std::vector<RenderLine_t>&& Lines ) -> void;
