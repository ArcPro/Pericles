...
{
public:
	// C_NetworkUtlVectorBase has the same 0x18-byte storage layout as the
	// CUtlVector used by this SDK. AnimGraph 2 packs its networked bools into
	// uint32 words in this vector.
	SCHEMA_OFFSET( "CAnimGraphNetworkedVariables" , "m_PredNetBoolVariables" , m_PredNetBoolVariables , CUtlVector<uint32_t> );
	SCHEMA_OFFSET( "CAnimGraphNetworkedVariables" , "m_nBoolVariablesCount" , m_nBoolVariablesCount , int32 );
};

class CBaseAnimGraphController
{
public:
	SCHEMA_OFFSET( "CBaseAnimGraphController" , "m_animGraphNetworkedVars" , m_animGraphNetworkedVars , CAnimGraphNetworkedVariables );
	SCHEMA_OFFSET( "CBaseAnimGraphController" , "m_hSequence" , m_hSequence , uint32_t );
	SCHEMA_OFFSET( "CBaseAnimGraphController" , "m_flSeqStartTime" , m_flSeqStartTime , float32 );
};
...
{
public:
	SCHEMA_OFFSET( "CBaseModifier" , "m_hAbility" , m_hAbility , CHandle );
};

class CModifierProperty
{
public:
	SCHEMA_OFFSET( "CModifierProperty" , "m_vecModifiers" , m_vecModifiers , CUtlVector<CBaseModifier*> );
};
...
public:
	...
	SCHEMA_OFFSET( "CGameSceneNode" , "m_angAbsRotation" , m_angAbsRotation , QAngle );
...
public:
	...
	auto IsCitadelNpc() -> bool;
	auto IsCitadelObjective() -> bool;
	auto IsItemXP() -> bool;
...
class CCitadel_Ability_HoldMelee : public C_CitadelBaseAbility
{
public:
	SCHEMA_OFFSET( "CCitadel_Ability_HoldMelee" , "m_eCurrentAttackState" , m_eCurrentAttackState , EMeleeHold_AttackState );
	SCHEMA_OFFSET( "CCitadel_Ability_HoldMelee" , "m_eCurrentAttackType" , m_eCurrentAttackType , EMeleeHold_AttackType );
};

class CItemXP : public C_BaseModelEntity
{
public:
	SCHEMA_OFFSET( "CItemXP" , "m_timeLaunch" , m_timeLaunch , float32 );
	SCHEMA_OFFSET( "CItemXP" , "m_flAttackableTime" , m_flAttackableTime , float32 );
	SCHEMA_OFFSET( "CItemXP" , "m_flEndAttackableTime" , m_flEndAttackableTime , float32 );
	SCHEMA_OFFSET( "CItemXP" , "m_nLaunchNum" , m_nLaunchNum , int32 );
};

class CBaseAnimGraph : public C_BaseModelEntity
{
public:
	SCHEMA_OFFSET( "CBaseAnimGraph" , "m_pMainGraphController" , m_pMainGraphController , CBaseAnimGraphController* );
};
...
{
public:
	SCHEMA_OFFSET( "C_AI_CitadelNPC" , "m_hLookTarget" , m_hLookTarget , CHandle );
};

class C_NPC_Trooper : public C_AI_CitadelNPC
{
public:
	SCHEMA_OFFSET( "C_NPC_Trooper" , "m_hTargetedEnemy" , m_hTargetedEnemy , CHandle );
};
...
{
public:
	SCHEMA_OFFSET( "C_NPC_Boss_Tier2" , "m_hTargetedEnemy" , m_hTargetedEnemy , CHandle );
};
...
private:
	PAD( 0x60 );
public:
	SCHEMA_OFFSET( "STeamFOWEntity" , "m_eClass" , m_eClass , uint32_t );
