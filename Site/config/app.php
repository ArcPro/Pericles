...
return [
    ...
    'support_email' => $_ENV['SUPPORT_EMAIL'] ?? 'support@pericles.gg',
    'launcher_download_url' => trim((string) ($_ENV['LAUNCHER_DOWNLOAD_URL'] ?? '')),
    ...
    'stripe_publishable_key' => trim((string) ($_ENV['STRIPE_PUBLISHABLE_KEY'] ?? '')),
    'stripe_secret_key' => trim((string) ($_ENV['STRIPE_SECRET_KEY'] ?? '')),
    'stripe_webhook_secret' => trim((string) ($_ENV['STRIPE_WEBHOOK_SECRET'] ?? '')),
    'db' => [
